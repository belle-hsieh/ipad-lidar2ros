...
final class ViewController: UIViewController, ARSessionDelegate {
    ...
    override func viewDidLoad() {
        ...
        if let view = view as? MTKView {
            ...
            view.center = view.superview?.center ?? CGPoint(x: 0, y: 0)
...
//        // Swap width and height to fill the rotated view
//        let rotatedFrame = CGRect(x: 0, y: 0, width: self.view.bounds.height, height: self.view.bounds.width)
//
//        let metalView = MTKView(frame: rotatedFrame, device: device)
//        metalView.backgroundColor = UIColor.clear
//        metalView.depthStencilPixelFormat = .depth32Float
//        metalView.contentScaleFactor = 1
//        metalView.delegate = self
//
//        // Rotate the MTKView 90 degrees clockwise
//        metalView.transform = CGAffineTransform(rotationAngle: .pi / 2)
//
//        // Center the metalView inside the parent view
//        metalView.center = self.view.center
//
//        self.view.addSubview(metalView)
//
//        // Configure renderer with correct size
